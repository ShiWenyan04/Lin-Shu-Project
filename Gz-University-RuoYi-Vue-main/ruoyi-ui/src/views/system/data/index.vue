      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            type="text"
            icon="el-icon-download"
            @click="$download.resource(scope.row.filePath,false)">
            下载</el-button>
        </template>
      </el-table-column>
      <el-table-column
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="文件类型" prop="fileType">
          <el-input v-model="form.fileType" placeholder="文件类型" readonly />
        </el-form-item>
        <el-form-item label="文件大小" prop="fileSize">
          <el-input v-model="form.fileSize" placeholder="文件大小" readonly />
        </el-form-item>
