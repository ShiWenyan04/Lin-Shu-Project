...
public class SysUser extends BaseEntity
{
    ...
    @Excel(name = "审核状态", readConverterExp = "0=待审核,1=审核通过,2=拒绝")
    ...
    // ... 原有 Getter/Setter ...
    // 请确保上面的 getNickName, getUserName, getEmail 等保持不变
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("undergradUniv", getUndergradUniv())
                .append("masterUniv", getMasterUniv())
                ...
                .append("emergencyRelation", getEmergencyRelation())
